...
extern void WriteIniKeyString(const char* title, const char* key, char* val, const char* filename);

extern void WriteChannelRtspConnect(char *channelName, char *connect, char *message);

extern void WriteChannelRtmpConnect(char *channelName, char *connect, char *message);
